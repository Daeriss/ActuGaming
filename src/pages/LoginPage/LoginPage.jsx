...
function LoginPage() {
    return(
        <div className="row g-0 justify-content-center align-items-center mb-3" style={{marginTop: "5em"}} >
                <div className={"w-30 d-flex justify-content-center form-inscription"} style={{backgroundColor: "rgb(124 83 146)"}}>
                ...
                <div className={"w-30 d-flex justify-content-center form-inscription"} style={{backgroundColor: "rgb(221 121 121)"}}>
